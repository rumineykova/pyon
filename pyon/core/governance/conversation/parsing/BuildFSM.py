# $ANTLR 3.1.3 Mar 18, 2009 10:09:25 parsing/BuildFSM.g 2013-02-21 21:01:46
...
class BuildFSM(TreeParser):
    grammarFileName = "parsing/BuildFSM.g"
    ...
    # parsing/BuildFSM.g:107:1: description : ^( PROTOCOL roleName parameterDefs ( activityDef )+ ) ;
    def description(self, ):

        try:
            try:
                # parsing/BuildFSM.g:107:12: ( ^( PROTOCOL roleName parameterDefs ( activityDef )+ ) )
                # parsing/BuildFSM.g:107:14: ^( PROTOCOL roleName parameterDefs ( activityDef )+ )
                pass 
                ...
                self._state.following.pop()
                # parsing/BuildFSM.g:107:48: ( activityDef )+
                cnt1 = 0
                while True: #loop1
                    alt1 = 2
    ...
    # parsing/BuildFSM.g:108:1: parameterDefs : ^( ROLES ( roleName )+ ) ;
    def parameterDefs(self, ):

        try:
            try:
                # parsing/BuildFSM.g:108:14: ( ^( ROLES ( roleName )+ ) )
                # parsing/BuildFSM.g:108:16: ^( ROLES ( roleName )+ )
                pass 
                self.match(self.input, ROLES, self.FOLLOW_ROLES_in_parameterDefs71)

                self.match(self.input, DOWN, None)
                # parsing/BuildFSM.g:108:24: ( roleName )+
                cnt2 = 0
                while True: #loop2
                    alt2 = 2
    ...
    # parsing/BuildFSM.g:109:1: activityDef : ( ^( RESV (rlabel= ID )? ( ^( VALUE ( (val= ID (vtype= ( INT | STRING ) )? ) )* ) ) role= ID ( ^( ASSERT (assertion= ASSERTION )? ) ) ) | ^( SEND (slabel= ID )? ( ^( VALUE ( (val= ID (vtype= ( INT | STRING ) )? ) )* ) ) role= ID ( ^( ASSERT (assertion= ASSERTION )? ) ) ) | ^( 'choice' ( ^( BRANCH ( activityDef )+ ) )+ ) | ^( PARALLEL ( ^( BRANCH ( activityDef )+ ) )+ ) | ^( 'repeat' ( ^( BRANCH ( activityDef )+ ) ) ) | ^( 'rec' label= ID ( ^( BRANCH ( activityDef )+ ) ) ) | ^( 'RECLABEL' labelID= ID ) | ^( GLOBAL_ESCAPE ( ^( 'do' ( ( activityDef )+ ) ) ) ( ^( 'interrupt' roleName ( ( activityDef )+ ) ) ) ) );
    def activityDef(self, ):
        ...
        try:
            try:
                # parsing/BuildFSM.g:109:12: ( ^( RESV (rlabel= ID )? ( ^( VALUE ( (val= ID (vtype= ( INT | STRING ) )? ) )* ) ) role= ID ( ^( ASSERT (assertion= ASSERTION )? ) ) ) | ^( SEND (slabel= ID )? ( ^( VALUE ( (val= ID (vtype= ( INT | STRING ) )? ) )* ) ) role= ID ( ^( ASSERT (assertion= ASSERTION )? ) ) ) | ^( 'choice' ( ^( BRANCH ( activityDef )+ ) )+ ) | ^( PARALLEL ( ^( BRANCH ( activityDef )+ ) )+ ) | ^( 'repeat' ( ^( BRANCH ( activityDef )+ ) ) ) | ^( 'rec' label= ID ( ^( BRANCH ( activityDef )+ ) ) ) | ^( 'RECLABEL' labelID= ID ) | ^( GLOBAL_ESCAPE ( ^( 'do' ( ( activityDef )+ ) ) ) ( ^( 'interrupt' roleName ( ( activityDef )+ ) ) ) ) )
                alt19 = 8
                ...
                if alt19 == 1:
                    # parsing/BuildFSM.g:110:2: ^( RESV (rlabel= ID )? ( ^( VALUE ( (val= ID (vtype= ( INT | STRING ) )? ) )* ) ) role= ID ( ^( ASSERT (assertion= ASSERTION )? ) ) )
                    pass 
                    ...
                    self.match(self.input, DOWN, None)
                    # parsing/BuildFSM.g:113:5: (rlabel= ID )?
                    alt3 = 2
                    ...
                    if (LA3_0 == ID) :
                        alt3 = 1
                    if alt3 == 1:
                        # parsing/BuildFSM.g:113:6: rlabel= ID
                        pass 
                    ...
                    # parsing/BuildFSM.g:116:5: ( ^( VALUE ( (val= ID (vtype= ( INT | STRING ) )? ) )* ) )
                    # parsing/BuildFSM.g:116:6: ^( VALUE ( (val= ID (vtype= ( INT | STRING ) )? ) )* )
                    pass 
                    self.match(self.input, VALUE, self.FOLLOW_VALUE_in_activityDef110)

                    if self.input.LA(1) == DOWN:
                        self.match(self.input, DOWN, None)
                        # parsing/BuildFSM.g:116:14: ( (val= ID (vtype= ( INT | STRING ) )? ) )*
                        while True: #loop5
                            alt5 = 2
                            ...
                            if alt5 == 1:
                                # parsing/BuildFSM.g:116:15: (val= ID (vtype= ( INT | STRING ) )? )
                                pass 
                                # parsing/BuildFSM.g:116:15: (val= ID (vtype= ( INT | STRING ) )? )
                                # parsing/BuildFSM.g:116:16: val= ID (vtype= ( INT | STRING ) )?
                                pass 
                                val=self.match(self.input, ID, self.FOLLOW_ID_in_activityDef116)
                                # parsing/BuildFSM.g:116:28: (vtype= ( INT | STRING ) )?
                                alt4 = 2
                    ...
                    #action end
                    # parsing/BuildFSM.g:118:5: ( ^( ASSERT (assertion= ASSERTION )? ) )
                    # parsing/BuildFSM.g:118:6: ^( ASSERT (assertion= ASSERTION )? )
                    pass 
                    self.match(self.input, ASSERT, self.FOLLOW_ASSERT_in_activityDef151)

                    if self.input.LA(1) == DOWN:
                        self.match(self.input, DOWN, None)
                        # parsing/BuildFSM.g:118:15: (assertion= ASSERTION )?
                        alt6 = 2
                        ...
                        if (LA6_0 == ASSERTION) :
                            alt6 = 1
                        if alt6 == 1:
                            # parsing/BuildFSM.g:118:16: assertion= ASSERTION
                            pass 
                    ...
                    # parsing/BuildFSM.g:123:3: ^( SEND (slabel= ID )? ( ^( VALUE ( (val= ID (vtype= ( INT | STRING ) )? ) )* ) ) role= ID ( ^( ASSERT (assertion= ASSERTION )? ) ) )
                    pass 
                    ...
                    self.match(self.input, DOWN, None)
                    # parsing/BuildFSM.g:126:5: (slabel= ID )?
                    alt7 = 2
                    ...
                    if (LA7_0 == ID) :
                        alt7 = 1
                    if alt7 == 1:
                        # parsing/BuildFSM.g:126:6: slabel= ID
                        pass 
                    ...
                    # parsing/BuildFSM.g:129:12: ( ^( VALUE ( (val= ID (vtype= ( INT | STRING ) )? ) )* ) )
                    # parsing/BuildFSM.g:129:13: ^( VALUE ( (val= ID (vtype= ( INT | STRING ) )? ) )* )
                    pass 
                    self.match(self.input, VALUE, self.FOLLOW_VALUE_in_activityDef201)

                    if self.input.LA(1) == DOWN:
                        self.match(self.input, DOWN, None)
                        # parsing/BuildFSM.g:129:21: ( (val= ID (vtype= ( INT | STRING ) )? ) )*
                        while True: #loop9
                            alt9 = 2
                            ...
                            if alt9 == 1:
                                # parsing/BuildFSM.g:129:22: (val= ID (vtype= ( INT | STRING ) )? )
                                pass 
                                # parsing/BuildFSM.g:129:22: (val= ID (vtype= ( INT | STRING ) )? )
                                # parsing/BuildFSM.g:129:23: val= ID (vtype= ( INT | STRING ) )?
                                pass 
                                val=self.match(self.input, ID, self.FOLLOW_ID_in_activityDef207)
                                # parsing/BuildFSM.g:129:35: (vtype= ( INT | STRING ) )?
                                alt8 = 2
                    ...
                    if not(role.text in self.roles): self.roles.append(role.text)
                    #action end
                    # parsing/BuildFSM.g:131:5: ( ^( ASSERT (assertion= ASSERTION )? ) )
                    # parsing/BuildFSM.g:131:6: ^( ASSERT (assertion= ASSERTION )? )
                    pass 
                    self.match(self.input, ASSERT, self.FOLLOW_ASSERT_in_activityDef246)

                    if self.input.LA(1) == DOWN:
                        self.match(self.input, DOWN, None)
                        # parsing/BuildFSM.g:131:15: (assertion= ASSERTION )?
                        alt10 = 2
                        ...
                        if (LA10_0 == ASSERTION) :
                            alt10 = 1
                        if alt10 == 1:
                            # parsing/BuildFSM.g:131:16: assertion= ASSERTION
                            pass 
                    ...
                    # parsing/BuildFSM.g:136:3: ^( 'choice' ( ^( BRANCH ( activityDef )+ ) )+ )
                    pass 
                    ...
                    self.match(self.input, DOWN, None)
                    # parsing/BuildFSM.g:141:2: ( ^( BRANCH ( activityDef )+ ) )+
                    cnt12 = 0
                    while True: #loop12
                        alt12 = 2
                        ...
                        if alt12 == 1:
                            # parsing/BuildFSM.g:141:3: ^( BRANCH ( activityDef )+ )
                            pass 
                            ...
                            self.match(self.input, DOWN, None)
                            # parsing/BuildFSM.g:146:4: ( activityDef )+
                            cnt11 = 0
                            while True: #loop11
                                alt11 = 2
                    ...
                    # parsing/BuildFSM.g:158:4: ^( PARALLEL ( ^( BRANCH ( activityDef )+ ) )+ )
                    pass 
                    ...
                    self.match(self.input, DOWN, None)
                    # parsing/BuildFSM.g:163:2: ( ^( BRANCH ( activityDef )+ ) )+
                    cnt14 = 0
                    while True: #loop14
                        alt14 = 2
                        ...
                        if alt14 == 1:
                            # parsing/BuildFSM.g:163:3: ^( BRANCH ( activityDef )+ )
                            pass 
                            ...
                            self.match(self.input, DOWN, None)
                            # parsing/BuildFSM.g:170:2: ( activityDef )+
                            cnt13 = 0
                            while True: #loop13
                                alt13 = 2
                                ...
                                if alt13 == 1:
                                    # parsing/BuildFSM.g:170:3: activityDef
                                    pass 
                    ...
                    # parsing/BuildFSM.g:180:3: ^( 'repeat' ( ^( BRANCH ( activityDef )+ ) ) )
                    pass 
                    ...
                    self.match(self.input, DOWN, None)
                    # parsing/BuildFSM.g:182:2: ( ^( BRANCH ( activityDef )+ ) )
                    # parsing/BuildFSM.g:182:3: ^( BRANCH ( activityDef )+ )
                    pass 
                    self.match(self.input, BRANCH, self.FOLLOW_BRANCH_in_activityDef361)

                    self.match(self.input, DOWN, None)
                    # parsing/BuildFSM.g:182:12: ( activityDef )+
                    cnt15 = 0
                    while True: #loop15
                        alt15 = 2
                        ...
                        if alt15 == 1:
                            # parsing/BuildFSM.g:182:13: activityDef
                            pass 
                    ...
                    # parsing/BuildFSM.g:185:10: ^( 'rec' label= ID ( ^( BRANCH ( activityDef )+ ) ) )
                    pass 
                    ...
                    #action end
                    # parsing/BuildFSM.g:189:2: ( ^( BRANCH ( activityDef )+ ) )
                    # parsing/BuildFSM.g:189:3: ^( BRANCH ( activityDef )+ )
                    pass 
                    self.match(self.input, BRANCH, self.FOLLOW_BRANCH_in_activityDef410)

                    self.match(self.input, DOWN, None)
                    # parsing/BuildFSM.g:189:12: ( activityDef )+
                    cnt16 = 0
                    while True: #loop16
                        alt16 = 2
                        ...
                        if alt16 == 1:
                            # parsing/BuildFSM.g:189:13: activityDef
                            pass 
                    ...
                    # parsing/BuildFSM.g:196:3: ^( 'RECLABEL' labelID= ID )
                    pass 
                    ...
                    # parsing/BuildFSM.g:213:3: ^( GLOBAL_ESCAPE ( ^( 'do' ( ( activityDef )+ ) ) ) ( ^( 'interrupt' roleName ( ( activityDef )+ ) ) ) )
                    pass 
                    self.match(self.input, GLOBAL_ESCAPE, self.FOLLOW_GLOBAL_ESCAPE_in_activityDef452)

                    self.match(self.input, DOWN, None)
                    # parsing/BuildFSM.g:214:5: ( ^( 'do' ( ( activityDef )+ ) ) )
                    # parsing/BuildFSM.g:214:6: ^( 'do' ( ( activityDef )+ ) )
                    pass 
                    self.match(self.input, 58, self.FOLLOW_58_in_activityDef461)

                    self.match(self.input, DOWN, None)
                    # parsing/BuildFSM.g:214:13: ( ( activityDef )+ )
                    # parsing/BuildFSM.g:214:14: ( activityDef )+
                    pass 
                    # parsing/BuildFSM.g:214:14: ( activityDef )+
                    cnt17 = 0
                    while True: #loop17
                    ...
                    # parsing/BuildFSM.g:215:5: ( ^( 'interrupt' roleName ( ( activityDef )+ ) ) )
                    # parsing/BuildFSM.g:215:6: ^( 'interrupt' roleName ( ( activityDef )+ ) )
                    pass 
                    ...
                    #action end
                    # parsing/BuildFSM.g:218:56: ( ( activityDef )+ )
                    # parsing/BuildFSM.g:218:57: ( activityDef )+
                    pass 
                    # parsing/BuildFSM.g:218:57: ( activityDef )+
                    cnt18 = 0
                    while True: #loop18
    ...
    # parsing/BuildFSM.g:220:1: roleName : role= ID ;
    def roleName(self, ):
        ...
        try:
            try:
                # parsing/BuildFSM.g:220:9: (role= ID )
                # parsing/BuildFSM.g:220:11: role= ID
                pass 
    ...
    # parsing/BuildFSM.g:223:1: labelName : ID ;
    def labelName(self, ):

        try:
            try:
                # parsing/BuildFSM.g:223:10: ( ID )
                # parsing/BuildFSM.g:223:12: ID
                pass 
    ...
    # $ANTLR start "roleDef"
    # parsing/BuildFSM.g:224:1: roleDef : ID ;
    def roleDef(self, ):

        try:
            try:
                # parsing/BuildFSM.g:224:8: ( ID )
                # parsing/BuildFSM.g:224:10: ID
                pass 
    ...
    # parsing/BuildFSM.g:225:1: primitivetype : INT ;
    def primitivetype(self, ):

        try:
            try:
                # parsing/BuildFSM.g:225:15: ( INT )
                # parsing/BuildFSM.g:225:16: INT
                pass 
